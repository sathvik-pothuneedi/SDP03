...
<html lang="en" dir="ltr">
   ...
   <body>
    ...
    <c:forEach items="${qblist}" var="course">
<option value="${course.id}">${course.id}</option>
    ...
    <select name="QB Title" required>
      <option value="">--Select--</option>
    <c:forEach items="${qblist}" var="qbtitle">
  
<option value="${qblist.questionbanktitle}">${course.questionbanktitle}</option>
...
<td> <c:out value="${q.option1}"></c:out>   </td>
<td> <c:out value="${q.option2}"></c:out>   </td>
<td> <c:out value="${q.option3}"></c:out>   </td>
<td> <c:out value="${q.option4}"></c:out>   </td>
<td> <c:out value="${q.correctoption}"></c:out>   </td>
      </tr>
      </c:forEach>
      </table>
